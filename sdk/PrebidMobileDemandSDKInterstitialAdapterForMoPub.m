...
#import "PrebidMobileDemandSDKInterstitialAdapterForMoPub.h"
#import "PrebidMobileDemandSDKLoadSettings.h"

@interface PrebidMobileDemandSDKInterstitialAdapterForMoPub()
...
@implementation PrebidMobileDemandSDKInterstitialAdapterForMoPub
...
- (void)requestInterstitialWithCustomEventInfo:(NSDictionary *)info {
    ...
    //NSString *keywords = [(MPInterstitialAdController *)[(MPBannerAdManager *)[adapterDelegate delegate] delegate] keywords];
    NSString *keywords;
